...
export default () => (
    ...
    <Header/> 
        ...
        <h2>About me</h2>
            ...
            <p>I've been building digital products for <strong>9 years</strong>. I'm currently working in Mexico City as a Product Designer. Before moving to Mexico city I was a Design Lead in one of the most important online education platforms in Latin America, <a href="https://platzi.com/ux" target="_blank" rel="noopener noreferrer" className="link">Platzi</a>.</p>
            <p>Platzi focuses on teaching programming but also on marketing and design. <strong> I was responsible for the product</strong> but at the same time gave 3 different courses about design, wrote articles, youtube tutorials and gave conferences in Mexico, Peru, and Bogota... all this about design.</p>
